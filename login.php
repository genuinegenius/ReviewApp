...
<div class='container'>
  <div class='window'>
    ...
    <div class='content'>
      ...
      <div class='subtitle'>We're almost done. Before using our services you must log in to your account account.</div>
      <div class='input-fields'>
        ...
        <input class='ghost-round full-width' type="submit" name="login" value="Login"></input>
        </form>
      </div>
    </div>
  </div>
